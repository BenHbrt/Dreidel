...
const Credits = ({ setInfo }) => {
    return (
        <div className="credits">
            ...
            <p>The inspiration for this project came simply from the time of year. I wanted to code something festive and seasonal, and as I like cooking latkes, I knew that Hanukkah was approaching!</p>
